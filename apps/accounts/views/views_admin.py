...
from apps.accounts.serializers.serializers_admin import AdminLoginSerializer, UserListAdminSerializer, \
    UserDetailAdminSerializer, UserUpdateAdminSerializer, UserCreateAdminSerializer, RoleCategoryListAdminSerializer, \
    RoleCategoryDetailAdminSerializer, RoleCategoryCreateAdminSerializer, RoleCategoryUpdateAdminSerializer, \
